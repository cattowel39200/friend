...
group = "com.yourcompany.friendlocator"
version = "1.0.0"

application {
    mainClass.set("com.yourcompany.friendlocator.ApplicationKt")
}
...
tasks.shadowJar {
    ...
    archiveVersion.set("")
    manifest {
        attributes["Main-Class"] = "com.yourcompany.friendlocator.ApplicationKt"
    }
}
